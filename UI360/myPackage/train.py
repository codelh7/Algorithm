...
def preprocess(data_dirs, document_length_limit, is_line_as_word, dev_sample_percentage):
    ...
    print 'x(dimension is %i) which were operated by tf: ' % len(x)
    print(x)
...
def runTrain():
    ...
    positive_data_dir = "/home/codelh7/data/train/pos"
    negative_data_dir = "/home/codelh7/data/train/neg"
    ...
    all_predictions = train(x_train, y_train, vocab_processor, x_dev, y_dev,
