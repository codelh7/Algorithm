...
def main():
    pos_dir = "/home/codelh7/data/test/pos"
    neg_dir = "/home/codelh7/data/test/neg"
    ...
    all_predictions = test(data_dirs, checkpoint_dir, document_length_limit, batch_size, is_line_as_word)
    return all_predictions

def runTest():
    print 'testing ... Plz wait a moment ...'
    os.chdir("/home/codelh7/data/program")
    all_predictions = main()
    return all_predictions
