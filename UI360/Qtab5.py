...
class Qtab5(QWidget):
    def __init__(self, parent=None):
        super(Qtab5, self).__init__(parent)
        self.palette = QPalette()
        
        self.about_help_dialog = AboutHelpDialog(self)
    ...
    def initLeft(self):
        ...
        self.connect(self.power_button, SIGNAL("clicked()"), self, SLOT("showAboutHelp()"))
    ...
    def translateLanguage(self):
        ...
        #self.suggest_label.setText("建议".decode('utf8'))
        #self.system_safe_label.setText("系统安全".decode('utf8'))
        self.power_button.setText("帮助".decode('utf8'))
        
        self.login_button.setText("登陆".decode('utf8'))
        self.info_label.setText("升级会员".decode('utf8'))
        self.register_button.setText("注册".decode('utf8'))
        self.privilege_label.setText("特权".decode('utf8'))
        
        self.fireproof_button.setText("放火前".decode('utf8'))
        self.triggerman_button.setText("网警".decode('utf8'))
        self.net_shop_button.setText("网上商城".decode('utf8'))
        
        self.function_label.setText("功能".decode('utf8'))
        self.more_button.setText("更多".decode('utf8'))
        self.recovery_button.setText("还原".decode('utf8'))
        self.mobile_button.setText("手机".decode('utf8'))
        self.game_box_button.setText("游戏盒子".decode('utf8'))
        self.desktop_button.setText("桌面".decode('utf8'))
        self.net_repair_button.setText("网络修复".decode('utf8'))
        self.auto_run_button.setText("自动运行".decode('utf8'))
        self.net_speed_button.setText("网络加速".decode('utf8'))
        self.net_pretext_button.setText("扫描网络".decode('utf8'))
        self.first_add_button.setText("急救".decode('utf8'))
        
        self.connect_label.setText(u"连接成功")
        self.version_label.setText(u"版本")
