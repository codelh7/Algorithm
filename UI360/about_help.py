...
class AboutHelpDialog(QDialog):
    
    def __init__(self, parent=None):
        super(AboutHelpDialog, self).__init__(parent)
    ...
    def translateLanguage(self):
        self.title_label.setText(u"超星杀毒软件")
        self.title_info_label.setText(u"超星杀毒软件")
        self.info_label.setText(u"杀木马 防盗号 电脑加速")
        self.version_label.setText(u"本系统可以进行\n\n电脑全盘查杀  关键位置快速查杀 指定位置查杀")
        self.mummy_label.setText(u"若在使用过程中遇到任何问题请联系我们 :0797-xxxxxxx")
        self.copyright_label.setText(u"Copyright(c) chaoxing.cn Inc.All Rights Reserved.")
