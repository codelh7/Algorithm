...
class Qtab2(QWidget):
    def __init__(self, parent=None):
        super(Qtab2, self).__init__(parent)
    ...
    def initLeft(self):
        ...
        self.connect(self.power_button, SIGNAL("clicked()"), self, SLOT("powerButton_clicked()"))
    ...
    def translateLanguage(self):
        ...
        self.power_button.setText("选择查杀位置".decode('utf8'))
